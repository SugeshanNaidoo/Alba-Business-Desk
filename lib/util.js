// Shared helpers used across the backend: strict CORS, and small cookie
// utilities used for OAuth CSRF protection (see oauth-meta.js / oauth-tiktok.js).
...
function setCookie(res, name, value, { maxAgeSeconds = 600 } = {}){
  const parts = [
...
module.exports = { setCors, parseCookies, setCookie };
